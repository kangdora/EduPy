...
class LoopAndListTest(unittest.TestCase):
    ...
    def test_for_반복문(self):
        ...
        # TODO: for문을 사용하여 numbers의 모든 요소를 result에 추가하세요. Hint -> append 키워드를 검색해보세요.
        for num in numbers:  # 이 부분을 채워보세요
            pass  # 이 부분을 수정하세요
    ...
    def test_range_사용(self):
        ...
        TODO: 위 두 가지 방법을 다 사용하여 1부터 5까지 숫자 리스트를 생성하세요.
        """
        result1 = None  # list() 이용
        result2 = None  # 리스트 컴프리헨션 이용
    ...
    def test_리스트_내_포함여부_확인(self):
        ...
        # TODO: "banana"가 리스트에 포함되어 있으면 True를 반환하세요. Hint -> in 연산자를 검색해보세요.
    ...
    def test_리스트_원소_합계(self):
        ...
        # TODO: 리스트 내 모든 요소의 합을 result에 저장하세요.
        result = None  # 이 부분을 수정하세요
