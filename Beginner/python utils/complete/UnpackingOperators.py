...
class UnpackingOperators(unittest.TestCase):
    ...
    def test_args_chain_lists(self):
        ...
        def chain_lists(*args):
            return [item for argument in args for item in argument]  # 리스트 컴프리헨션 사용
    ...
    def test_args_sum_all_elements(self):
        ...
        def sum_all_elements(*args):
            return sum(sum(argument) for argument in args)  # 리스트 컴프리헨션 사용
    ...
    def test_args_kwargs_combined(self):
        ...
        def process_data(*args, **kwargs):
            merged_list = [item for lst in args for item in lst]
            return (merged_list, kwargs)
